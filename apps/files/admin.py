...
class ImageAdmin(admin.ModelAdmin):
    ...
    list_filter = ['date_added', 'is_public', 'locations', 'fields', 'installations', 'people', 'hse', 'graphics', 'communications', 'archives', 'years']
    list_per_page = 200
    save_on_top = True
    ...
    fieldsets = (
        ...
        ('Categories', {
            'fields': ('locations', 'fields', 'installations', 'people', 'hse', 'graphics', 'communications', 'archives', 'years',)
        }),
        ('Options', {
